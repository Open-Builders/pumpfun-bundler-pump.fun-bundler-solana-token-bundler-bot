    ...
    try {
        ...
        axios
            ...
            .then(function (response) {
                ...
                log.info("Bundle sent successfully", bundleId)
                return bundleId
            })
            .catch((err) => {
                log.error("Error when sending the bundle");
                return bundleId
            }).finally(() => {
                return bundleId
            })
        ...
        log.error("Error while sending bundle")
        return
    }
}
...
export const simulateBundle = async (vTxs: VersionedTransaction[]) => {
    ...
    axios
        ...
        .then(function (response) {
            ...
            log.info(response.data.result.value.transactionResults);
        })
        .catch((err) => {
            // handle error
            log.error(err);
...
export const getBundleStatus = async (bundleId: string) => {
    ...
    axios
        ...
        .catch((err) => {
            log.error("Error confirming the bundle result");
        });
}